...
#'   \item{species_code}{
#'     Three-letter species code following the
#'     ASPE database convention.
#'   }
...
#'   (\url{https://github.com/Fellows-of-the-Fish-Food-Webs-F3W/}
#'   \url{fishdatabuilder}),
#'   based on data from Irz P, Vigneron T, Poulet N, Cosson E,
